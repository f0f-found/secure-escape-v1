...
> 👉 Then: Open PR → Get approval → Merge ✅
...
| ❌ NEVER | ✅ ALWAYS |
|---|---|
| Commit directly to `main` | Create a new branch |
| Push directly to `main` | Use clear commit messages |
| Merge your own PR without review | Open a Pull Request |
