// screens/Screen_CardDetail.js – with fixed dimensions for both card sides
...
export default function Screen_CardDetail() {
    ...
    const handleFreezeToggle = (value) => {
        if (value) setFreezeModalVisible(true);
        else {
            setFreezeCard(false);
            Alert.alert(
                "Card Unfrozen",
                "Your card is now active and can be used normally.",
            );
        }
    };
    const confirmFreeze = () => {
        ...
        Alert.alert(
            "Card Frozen",
            "No payments, subscriptions or withdrawals can be made while it's frozen.",
        );
    };

    const handleOnlinePurchases = (value) => {
    ...
    const handleInternational = (value) => {
            ...
            [
                {
                    ...
                    onPress: () =>
                        Alert.alert(
                            "Reported",
                            "We've blocked your card. A new one will be issued.",
                        ),
                },
                {
                    text: "Replace",
                    onPress: () =>
                        Alert.alert(
                            "Replacement",
                            "A new card will be sent to your branch.",
                        ),
                },
    ...
    const handleUpdateLimits = () => {
        navigation.navigate("TempLimits", { card, mode: "permanent" });
    };

    const handleTempLimits = () => {
        navigation.navigate("TempLimits", { card, mode: "temporary" });
    };
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <View style={styles.cardWrapper}>
                    <View style={styles.cardContainer}>
                        ...
                        {/* BACK SIDE – same dimensions, compact details */}
                        <Animated.View
                            style={[
                                styles.flipCard,
                                styles.backCard,
                ...
                {/* Toggles and Action Sections (unchanged) */}
                <View style={styles.toggleSection}>
                    <View style={styles.toggleItem}>
                        <View style={styles.toggleTextContainer}>
                            <Text style={styles.toggleTitle}>Freeze card</Text>
                            <Text style={styles.toggleDescription}>
                                Lost or misplaced your card? No transactions can be done while
                                it's frozen.
                            </Text>
                        </View>
                        <Switch
                            ...
                            trackColor={{ false: "#ddd", true: colors.purple }}
                    ...
                    <View style={styles.toggleItem}>
                        <View style={styles.toggleTextContainer}>
                            ...
                            <Text style={styles.toggleDescription}>
                                Use your card to make international transactions
                            </Text>
                        </View>
                        <Switch
                ...
                <View style={styles.missingSection}>
                    ...
                    <Text style={styles.missingDescription}>
                        Search for Capitec in your phone's settings and switch on location
                ...
                <View style={styles.actionSection}>
                    <TouchableOpacity style={styles.actionItem} onPress={handleTapToPay}>
                        <Ionicons name="tap-outline" size={22} color={colors.navy} />
                        <Text style={styles.actionText}>Tap to pay</Text>
                        <Ionicons name="chevron-forward" size={20} color="#ccc" />
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.actionItem}
                        onPress={handleReplaceStop}
                    >
                ...
                >
                    <View style={styles.warningModalContent}>
                        ...
                        <Text style={styles.warningDescription}>
                            ...
                            will never ask for your PIN or CVV.
                        </Text>
                        <TouchableOpacity
                ...
                >
                    <View style={styles.confirmModalContent}>
                        ...
                        <Text style={styles.confirmDescription}>
                            You are about to freeze your card. No payments, subscriptions or
                            withdrawals can be made while it&apos;s frozen.
                        </Text>
            ...
            <BottomNav navigation={navigation} activeTab="Cards" />
        </View>
    );
}
...
const styles = StyleSheet.create({
    ...
    cardContainer: {
        width: "100%",
        height: 220, // fixed height – same for both sides
        alignItems: "center",
    ...
    cardBack: {
        // no extra height – content will be centered inside the fixed-height card
    },
    cardHeader: {
        flexDirection: "row",
        justifyContent: "space-between",
    ...
    learnMoreText: { fontSize: 13, fontWeight: "600", color: colors.purple },
    missingSection: {
        backgroundColor: "#fff",
        marginHorizontal: 20,
        borderRadius: 16,
