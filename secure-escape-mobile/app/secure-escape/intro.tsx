...
export default function SecureEscapeSplashPage() {
  ...
  return (
    ...
    >
      ...
      {/* Text content – moved up and centered */}
      <Animated.View
        style={[
          styles.content,
          {
      ...
      >
        ...
        <Text style={styles.tagline}>Silent protection when you need it most</Text>
              ...
              >
                ...
                <View style={styles.bulletList}>
                  <View style={styles.bulletItem}>
                    ...
                    <Text style={styles.bulletText}>Show attackers a realistic balance (not your real money)</Text>
                  </View>
                  <View style={styles.bulletItem}>
                    <Ionicons name="checkmark-circle" size={20} color={colors.primary} />
                    <Text style={styles.bulletText}>Only make a small, bank‑guaranteed amount available</Text>
                  </View>
                  <View style={styles.bulletItem}>
                    <Ionicons name="checkmark-circle" size={20} color={colors.primary} />
                    <Text style={styles.bulletText}>Silently alert police with your GPS location</Text>
                  </View>
                  <View style={styles.bulletItem}>
                    <Ionicons name="checkmark-circle" size={20} color={colors.primary} />
                    <Text style={styles.bulletText}>Freeze the rest of your money for 72 hours</Text>
                  </View>
                </View>
